	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        _reactRouter.Router,
	        null,
	        _react2.default.createElement(_reactRouter.Route, { path: '/', component: _logo2.default }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactBaseLogo = function (_React$Component) {
	  _inherits(ReactBaseLogo, _React$Component);

	  function ReactBaseLogo() {
	    _classCallCheck(this, ReactBaseLogo);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(ReactBaseLogo).apply(this, arguments));
	  }

	  _createClass(ReactBaseLogo, [{
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement('img', { onClick: _actions2.default.addItem.bind(null, 'hola'), src: './logo.png', alt: 'ReactBase', width: '300' });
	    }
	  }]);

	  return ReactBaseLogo;
	}(_react2.default.Component);

	exports.default = ReactBaseLogo;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dispatcher = __webpack_require__(209);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	exports.default = {
	  addItem: function addItem(item) {
	    (0, _dispatcher.mainDispatcher)({
	  ...
	  removeItem: function removeItem(item) {
	    Dispatcher({
	      actionType: _constants2.default.REMOVE_ITEM,
	      data: item
	    });
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	function mainDispatcher(actionType, action) {
