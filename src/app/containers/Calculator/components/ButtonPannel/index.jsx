      ...
      <div className={ styles.ButtonPanel }>
        <div className={ styles.Column }>
          <div className={ styles.Row }>
            <Button type="number" value="C" onClick={ () => this.actions.inputOperation(Types.CLEAN) } />
            <Button type="number" value="+/-" onClick={ () => this.actions.inputOperation(Types.CHANGE_SIGN) } />
            <Button type="number" value="%" onClick={ () => this.actions.inputOperation(Types.PERCENT) } />
